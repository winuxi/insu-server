...
use App\Models\User;
use Laravel\Fortify\Contracts\TwoFactorLoginResponse as CustomTwoFactorLoginResponse;

class TwoFactorLoginResponse implements CustomTwoFactorLoginResponse
{
